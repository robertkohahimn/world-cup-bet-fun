...
// Seed everything atomically: a mid-way failure rolls back completely, so the
// rerun guard above never trips on a half-seeded database.
...
console.log("Friends: sam@wcbet.fun / priya@wcbet.fun / leo@wcbet.fun, same password.");
